        ...
        <div className='flex items-center gap-2'>
          <label className='whitespace-nowrap font-semibold'>
            Search Term:
                    ...
                    <input type="text" name="" id="searchTerm" placeholder='Search...'
                ...
                <div className="flex gap-2 flex-wrap items-center">
                    <label className='font-semibold' htmlFor="">Ameneties:</label>
                    <div className="flex gap-2">
                        <input type="checkbox" name="" id="parking" className='w-5' onChange={handleChange} checked={sideBarData.parking} />
                        <span>Parking</span>
                    </div>
                    <div className="flex gap-2">
                        <input type="checkbox" name="" id="furnished" className='w-5' onChange={handleChange} checked={sideBarData.furnishedoffer} />
                        <span>Furnished</span>
                    </div>
                </div>
                <div className="flex items-center gap-2">
